...
(defmacro get-config
  "Gives configuration options set by the test.
   ...
   Signature of the result value put on the channel is [test-config] where:
     ...
     |test-config| - https://developer.chrome.com/apps/test#property-callback-testConfig.

   In case of error the channel closes without receiving any result and relevant error object can be obtained via
   chromex.error/get-last-error.

   https://developer.chrome.com/apps/test#method-getConfig."
...
(defmacro notify-fail
  "Notifies the browser process that test code running in the extension failed.  This is only used for internal unit testing.
     ...
     |message| - https://developer.chrome.com/apps/test#property-notifyFail-message.

   https://developer.chrome.com/apps/test#method-notifyFail."
...
(defmacro notify-pass
  "Notifies the browser process that test code running in the extension passed.  This is only used for internal unit testing.
     ...
     |message| - https://developer.chrome.com/apps/test#property-notifyPass-message.

   https://developer.chrome.com/apps/test#method-notifyPass."
...
(defmacro log
  "Logs a message during internal unit testing.
     ...
     |message| - https://developer.chrome.com/apps/test#property-log-message.

   https://developer.chrome.com/apps/test#method-log."
...
(defmacro send-message
  "Sends a string message to the browser process, generating a Notification that C++ test code can wait for.
     ...
     |message| - https://developer.chrome.com/apps/test#property-sendMessage-message.

   This function returns a core.async channel which eventually receives a result value and closes.
   Signature of the result value put on the channel is [response] where:

     |response| - https://developer.chrome.com/apps/test#property-callback-response.

   In case of error the channel closes without receiving any result and relevant error object can be obtained via
   chromex.error/get-last-error.

   https://developer.chrome.com/apps/test#method-sendMessage."
  ([message] (gen-call :function ::send-message &form message)))

(defmacro callback-added
  "https://developer.chrome.com/apps/test#method-callbackAdded."
  ([] (gen-call :function ::callback-added &form)))

(defmacro run-next-test
  "https://developer.chrome.com/apps/test#method-runNextTest."
  ([] (gen-call :function ::run-next-test &form)))

(defmacro fail
  "  |message| - https://developer.chrome.com/apps/test#property-fail-message.

   https://developer.chrome.com/apps/test#method-fail."
  ([message] (gen-call :function ::fail &form message))
  ([] `(fail :omit)))

(defmacro succeed
  "  |message| - https://developer.chrome.com/apps/test#property-succeed-message.

   https://developer.chrome.com/apps/test#method-succeed."
...
(defmacro get-module-system
  "Returns an instance of the module system for the given context.
     ...
     |context| - https://developer.chrome.com/apps/test#property-getModuleSystem-context.

   https://developer.chrome.com/apps/test#method-getModuleSystem."
  ([context] (gen-call :function ::get-module-system &form context)))

(defmacro assert-true
  "  |test| - https://developer.chrome.com/apps/test#property-assertTrue-test.
     |message| - https://developer.chrome.com/apps/test#property-assertTrue-message.

   https://developer.chrome.com/apps/test#method-assertTrue."
  ([test message] (gen-call :function ::assert-true &form test message))
  ([test] `(assert-true ~test :omit)))

(defmacro assert-false
  "  |test| - https://developer.chrome.com/apps/test#property-assertFalse-test.
     |message| - https://developer.chrome.com/apps/test#property-assertFalse-message.

   https://developer.chrome.com/apps/test#method-assertFalse."
  ([test message] (gen-call :function ::assert-false &form test message))
  ([test] `(assert-false ~test :omit)))

(defmacro assert-bool
  "  |test| - https://developer.chrome.com/apps/test#property-assertBool-test.
     |expected| - https://developer.chrome.com/apps/test#property-assertBool-expected.
     |message| - https://developer.chrome.com/apps/test#property-assertBool-message.

   https://developer.chrome.com/apps/test#method-assertBool."
...
(defmacro check-deep-eq
  "  |expected| - https://developer.chrome.com/apps/test#property-checkDeepEq-expected.
     |actual| - https://developer.chrome.com/apps/test#property-checkDeepEq-actual.

   https://developer.chrome.com/apps/test#method-checkDeepEq."
...
(defmacro assert-eq
  "  |expected| - https://developer.chrome.com/apps/test#property-assertEq-expected.
     |actual| - https://developer.chrome.com/apps/test#property-assertEq-actual.
     |message| - https://developer.chrome.com/apps/test#property-assertEq-message.

   https://developer.chrome.com/apps/test#method-assertEq."
...
(defmacro assert-no-last-error
  "https://developer.chrome.com/apps/test#method-assertNoLastError."
  ([] (gen-call :function ::assert-no-last-error &form)))

(defmacro assert-last-error
  "  |expected-error| - https://developer.chrome.com/apps/test#property-assertLastError-expectedError.

   https://developer.chrome.com/apps/test#method-assertLastError."
  ([expected-error] (gen-call :function ::assert-last-error &form expected-error)))

(defmacro assert-throws
  "  |fn| - https://developer.chrome.com/apps/test#property-assertThrows-fn.
     |self| - https://developer.chrome.com/apps/test#property-assertThrows-self.
     |args| - https://developer.chrome.com/apps/test#property-assertThrows-args.
     |message| - https://developer.chrome.com/apps/test#property-assertThrows-message.

   https://developer.chrome.com/apps/test#method-assertThrows."
...
(defmacro callback
  "  |func| - https://developer.chrome.com/apps/test#property-callback-func.
     |expected-error| - https://developer.chrome.com/apps/test#property-callback-expectedError.

   https://developer.chrome.com/apps/test#method-callback."
  ([func expected-error] (gen-call :function ::callback &form func expected-error))
  ([func] `(callback ~func :omit))
  ([] `(callback :omit :omit)))

(defmacro listen-once
  "  |event| - https://developer.chrome.com/apps/test#property-listenOnce-event.
   ...
   https://developer.chrome.com/apps/test#method-listenOnce."
  ([event] (gen-call :function ::listen-once &form event)))

(defmacro listen-forever
  "  |event| - https://developer.chrome.com/apps/test#property-listenForever-event.
   ...
   https://developer.chrome.com/apps/test#method-listenForever."
...
(defmacro callback-pass
  "This function returns a core.async channel which eventually receives a result value and closes.
   ...
   https://developer.chrome.com/apps/test#method-callbackPass."
  ([] (gen-call :function ::callback-pass &form)))

(defmacro callback-fail
  "  |expected-error| - https://developer.chrome.com/apps/test#property-callbackFail-expectedError.
   ...
   https://developer.chrome.com/apps/test#method-callbackFail."
  ([expected-error] (gen-call :function ::callback-fail &form expected-error)))

(defmacro run-tests
  "  |tests| - https://developer.chrome.com/apps/test#property-runTests-tests.

   https://developer.chrome.com/apps/test#method-runTests."
  ([tests] (gen-call :function ::run-tests &form tests)))

(defmacro get-api-features
  "https://developer.chrome.com/apps/test#method-getApiFeatures."
  ([] (gen-call :function ::get-api-features &form)))

(defmacro get-api-definitions
  "  |api-names| - https://developer.chrome.com/apps/test#property-getApiDefinitions-apiNames.

   https://developer.chrome.com/apps/test#method-getApiDefinitions."
...
(defmacro is-processing-user-gesture
  "https://developer.chrome.com/apps/test#method-isProcessingUserGesture."
...
(defmacro run-with-user-gesture
  "Runs the callback in the context of a user gesture.
   ...
   https://developer.chrome.com/apps/test#method-runWithUserGesture."
...
(defmacro run-without-user-gesture
  "This function returns a core.async channel which eventually receives a result value and closes.
   ...
   https://developer.chrome.com/apps/test#method-runWithoutUserGesture."
...
(defmacro wait-for-round-trip
  "Sends a string message one round trip from the renderer to the browser process and back.
     ...
     |message| - https://developer.chrome.com/apps/test#property-waitForRoundTrip-message.

   This function returns a core.async channel which eventually receives a result value and closes.
   Signature of the result value put on the channel is [message] where:

     |message| - https://developer.chrome.com/apps/test#property-callback-message.

   In case of error the channel closes without receiving any result and relevant error object can be obtained via
   chromex.error/get-last-error.

   https://developer.chrome.com/apps/test#method-waitForRoundTrip."
...
(defmacro set-exception-handler
  "Sets the function to be called when an exception occurs. By default this is a function which fails the test. This is reset
   ...
   Signature of the result value put on the channel is [message exception] where:
     ...
     |message| - https://developer.chrome.com/apps/test#property-callback-message.
     |exception| - https://developer.chrome.com/apps/test#property-callback-exception.

   In case of error the channel closes without receiving any result and relevant error object can be obtained via
   chromex.error/get-last-error.

   https://developer.chrome.com/apps/test#method-setExceptionHandler."
...
(defmacro get-wake-event-page
  "Returns the wake-event-page API function, which can be called to wake up the extension's event page.
   ...
   https://developer.chrome.com/apps/test#method-getWakeEventPage."
...
(defmacro tap-on-message-events
  "Used to test sending messages to extensions.
   ...
   Events will be put on the |channel| with signature [::on-message [info]] where:
     ...
     |info| - https://developer.chrome.com/apps/test#property-onMessage-info.

   Note: |args| will be passed as additional parameters into Chrome event's .addListener call.

   https://developer.chrome.com/apps/test#event-onMessage."
  ([channel & args] (apply gen-call :event ::on-message &form channel args)))

; -- convenience ------------------------------------------------------------------------------------------------------------

(defmacro tap-all-events
  "Taps all valid non-deprecated events in chromex.app.test namespace."
  [chan]
