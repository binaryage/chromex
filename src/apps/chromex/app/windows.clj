...
(defmacro get
  "Gets details about a window.
     ...
     |query-options| - https://developer.chrome.com/apps/windows#property-get-queryOptions.
...
(defmacro get-current
  "Gets the current window.
     ...
     |query-options| - https://developer.chrome.com/apps/windows#property-getCurrent-queryOptions.
...
(defmacro get-last-focused
  "Gets the window that was most recently focused &mdash; typically the window 'on top'.
     ...
     |query-options| - https://developer.chrome.com/apps/windows#property-getLastFocused-queryOptions.
...
(defmacro get-all
  "Gets all windows.
     ...
     |query-options| - https://developer.chrome.com/apps/windows#property-getAll-queryOptions.
