...
(defmacro settings
  ...
  [#_callback]
  (gen-call :function ::settings (meta &form)))
...
(defmacro remove
  ...
  [options data-to-remove #_callback]
  (gen-call :function ::remove (meta &form) options data-to-remove))
...
(defmacro remove-appcache
  ...
  [options #_callback]
  (gen-call :function ::remove-appcache (meta &form) options))
...
(defmacro remove-cache
  ...
  [options #_callback]
  (gen-call :function ::remove-cache (meta &form) options))
...
(defmacro remove-cookies
  ...
  [options #_callback]
  (gen-call :function ::remove-cookies (meta &form) options))
...
(defmacro remove-downloads
  ...
  [options #_callback]
  (gen-call :function ::remove-downloads (meta &form) options))
...
(defmacro remove-file-systems
  ...
  [options #_callback]
  (gen-call :function ::remove-file-systems (meta &form) options))
...
(defmacro remove-form-data
  ...
  [options #_callback]
  (gen-call :function ::remove-form-data (meta &form) options))
...
(defmacro remove-history
  ...
  [options #_callback]
  (gen-call :function ::remove-history (meta &form) options))
...
(defmacro remove-indexed-db
  ...
  [options #_callback]
  (gen-call :function ::remove-indexed-db (meta &form) options))
...
(defmacro remove-local-storage
  ...
  [options #_callback]
  (gen-call :function ::remove-local-storage (meta &form) options))
...
(defmacro remove-plugin-data
  ...
  [options #_callback]
  (gen-call :function ::remove-plugin-data (meta &form) options))
...
(defmacro remove-passwords
  ...
  [options #_callback]
  (gen-call :function ::remove-passwords (meta &form) options))
...
(defmacro remove-web-sql
  ...
  [options #_callback]
  (gen-call :function ::remove-web-sql (meta &form) options))
