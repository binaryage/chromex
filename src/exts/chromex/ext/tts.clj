...
(defmacro stop
  "Stops any current speech and flushes the queue of any pending utterances. In addition, if speech was paused, it will now be
   ...
   https://developer.chrome.com/extensions/tts#method-stop."
  ([] (gen-call :function ::stop &form)))

(defmacro pause
  "Pauses speech synthesis, potentially in the middle of an utterance. A call to resume or stop will un-pause speech.

   https://developer.chrome.com/extensions/tts#method-pause."
  ([] (gen-call :function ::pause &form)))

(defmacro resume
  "If speech was paused, resumes speaking where it left off.

   https://developer.chrome.com/extensions/tts#method-resume."
