...
(defmacro tap-on-unmount-requested
...
(defmacro tap-on-get-metadata-requested
...
(defmacro tap-on-get-actions-requested
...
(defmacro tap-on-read-directory-requested
...
(defmacro tap-on-open-file-requested
...
(defmacro tap-on-close-file-requested
...
(defmacro tap-on-read-file-requested
...
(defmacro tap-on-create-directory-requested
...
(defmacro tap-on-delete-entry-requested
...
(defmacro tap-on-create-file-requested
...
(defmacro tap-on-copy-entry-requested
...
(defmacro tap-on-move-entry-requested
...
(defmacro tap-on-truncate-requested
...
(defmacro tap-on-configure-requested
...
(defmacro tap-on-mount-requested
...
(defmacro tap-on-add-watcher-requested
...
(defmacro tap-on-remove-watcher-requested
...
(defmacro tap-on-execute-action-requested
