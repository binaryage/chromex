...
(defmacro send-array-buffer
  "Functions for testing binary data request/response parameters. The first two just return back the bytes they were
   passed in an array."
  [input #_cb]
  (gen-call :function ::send-array-buffer (meta &form) input))
...
(defmacro send-array-buffer-view
  ...
  [input #_cb]
  (gen-call :function ::send-array-buffer-view (meta &form) input))

(defmacro get-array-buffer [#_cb]
  (gen-call :function ::get-array-buffer (meta &form)))
...
(defmacro nocompile-func
  ...
  [switch]
  (gen-call :function ::nocompile-func (meta &form) switch))
