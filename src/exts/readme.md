...
Generated 81 namespaces containing 53 properties, 391 functions and 181 events:
    ...
    |          chrome.declarativeNetRequest |           3 |          5 |       1 |
...
(ns your.project
  (:require
    ...
    [chromex.ext.printing refer:[
      get-printers tap-on-job-status-changed tap-all-events]]
