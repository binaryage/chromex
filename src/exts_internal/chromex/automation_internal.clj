...
(defmacro tap-on-accessibility-event-events
  ...
  ([channel] (gen-call :event ::on-accessibility-event &form channel)))

(defmacro tap-on-accessibility-tree-destroyed-events ([channel] (gen-call :event ::on-accessibility-tree-destroyed &form channel)))
