...
(defmacro context-menus-create
  ...
  ([create-properties #_callback] (gen-call :function ::context-menus-create (meta &form) create-properties)))
...
(defmacro context-menus-update
  ...
  ([id update-properties #_callback] (gen-call :function ::context-menus-update (meta &form) id update-properties)))
...
(defmacro context-menus-remove
  ...
  ([menu-item-id #_callback] (gen-call :function ::context-menus-remove (meta &form) menu-item-id)))
...
(defmacro context-menus-remove-all
  ...
  ([#_callback] (gen-call :function ::context-menus-remove-all (meta &form))))
...
(defmacro show-context-menu
  ...
  ([instance-id request-id items-to-show] (gen-call :function ::show-context-menu (meta &form) instance-id request-id items-to-show))
